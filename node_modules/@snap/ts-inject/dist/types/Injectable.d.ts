 ...
 */
export declare function Injectable<Token extends TokenType, Service>(token: Token, fn: () => Service): InjectableFunction<any, [], Token, Service>;
/**
 ...
 */
export declare function InjectableCompat<Token extends TokenType, Tokens extends readonly TokenType[], Params extends readonly any[], Service>(token: Token, dependencies: Tokens, fn: (...args: Tokens["length"] extends Params["length"] ? Params : void[]) => Service): ReturnType<typeof Injectable>;
/**
 ...
 */
export declare function ClassInjectable<Class extends InjectableClass<any, any, any>, Dependencies extends ConstructorParameters<Class>, Token extends TokenType, Tokens extends Class["dependencies"]>(token: Token, cls: Class): InjectableFunction<ServicesFromTokenizedParams<Tokens, Dependencies>, Tokens, Token, ConstructorReturnType<Class>>;
/**
 ...
 */
export declare function ConcatInjectable<Token extends TokenType, Service>(token: Token, fn: () => Service): InjectableFunction<{
